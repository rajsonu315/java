...
var AssetReportFilter = function(){
    var self = this;
    ...
    self.clearForm = function(){
        ...
        document.getElementById("assetReportForm").reset();
    }

    self.openAssetUtilizationReport = function(option){
        ...
        if(0==option){
            ...
            document.assetReportForm.target = "_blank";

        }else{
            document.getElementById('targetScreen').value ="Excel";
            document.assetReportForm.target = "responseFrame";

        }
        document.assetReportForm.submit();
    }
}
var assetReportFilter = new AssetReportFilter();