var FuelList = function(){
    var self = this;
            ...
            self.okClick = function(){
                ...
                var selectedValue ;
                var selectedIndex = document.searchFuelListForm.results_list.selectedIndex;

                if(selectedIndex >= 0) {
                    selectedValue = (document.searchFuelListForm.results_list.options[selectedIndex].value);
                } else {
