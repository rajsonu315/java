//this js will implement a scrollable table

var finalizeMe = (function(){
alert("finalizeMe var" );
...
alert("2TableScroll-if");
			InitializeMe(function(){
				var newTable, testCell;
alert("InitializeMe-" + notAbort);
				...
				if(
					...
					notAbort = false;
alert("2TableScroll-!notAbort");
				}
alert("5TableScroll-!done" + notAbort )
			});
alert("3TableScroll-!notAbort");
		}else{
			notAbort = false;
                        alert("1TableScroll-!" + notAbort);
		}

                alert("TableScroll-true" + notAbort);
		return true;
	}
	function main(){
		var id;
                alert("main-" + arguments.length+ notAbort);
