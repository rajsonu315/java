<%-- 
    Document   : AssetReportFilter
    Created on : Apr 5, 2013, 6:03:28 PM
    Author     : ubqtech035
--%>
...
<%
            ...
            String isShowlostOfTime = (String) request.getAttribute("isShowlostOfTime");
...
<div id="workingDiv">
    <input type="hidden" name="jsFile" value="<%= project%>/js/assetUtlization/AssetReportFilter.js">
    <form name="assetReportForm" id="assetReportForm" method="post"action="AssetUtilizationServlet" target="entryResponseFrame">
        ...
        <input type="hidden" name="command" id="command" value="<%=reportName%>">
                                    ...
                                    <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                        <tr style="height: 28px">
                                            <td valign="top" width="15%">
                                                <input type="radio" id="dateRange" name="dateType" value="0" onclick="assetReportFilter.setFilter(0);" checked>
                                        ...
                                        <tr style="height: 28px">
                                            <td width="15%">
                                                <input type="radio" id="cumulative" name="dateType" value="1" onclick="assetReportFilter.setFilter(1)" >
                                            ...
                                            <td width="100%"  valign="top">
                                                <div name = "cumulativeDiv" id ="cumulativeDiv" style="display:none ;visibility: hidden">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                                                        <tr>
                                                            <td>
                                                                &nbsp;&nbsp; Year <select id="selectYear" name="selectYear" onchange="assetReportFilter.formDate('selectedFromDate','selectedToDate')" style="width: 80px">
                                                                    <%
                                                                ...
                                                                &nbsp;&nbsp; Month <select id="selectMonth" name="selectMonth"  style="width: 80px" onchange="assetReportFilter.formDate('selectedFromDate','selectedToDate')">
                                                                ...
                                                                &nbsp;&nbsp; Week <select id="selectWeek" name="selectWeek"  style="width: 80px" onchange="assetReportFilter.formDate('selectedFromDate','selectedToDate')">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td  align="right">
                    ...
                    <input type="button" name="viewButton" id="viewButton" value=" View " class="buttonSize" onclick="assetReportFilter.openAssetUtilizationReport(0)">&nbsp;
                    <input type="button" name="viewButton" id="viewButton" value=" Excel Export" class="buttonSize" onclick="assetReportFilter.openAssetUtilizationReport(1)">&nbsp;
                    <input type="button" name="clearButton" id="clearButton" value=" Clear " onClick="assetReportFilter.clearForm()" class="buttonSize">
                </td>
            </tr>
        </table>
