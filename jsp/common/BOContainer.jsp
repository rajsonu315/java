...
<div style="height: 400px;overflow: auto">
    ...
    boolean isPopup = ctxt.getAttribute("isPopup") != null;
...
<!-- changed by subhransu, as it was removing desktopWell row -->
<!--                                <input type="button" value="Close" onclick="desktop.closeInset(dynTableGetTable(dynTableRow(dynTableGetTable(this))))" > &nbsp;-->
                                <input type="button" value="Close" onclick="desktop.closeInset((dynTableGetTable(this)))" > &nbsp;
                                <% } %>
                            </td>
                        </tr>
